...
void add_rbd_atime_period_option(po::options_description *opt) {
  std::string description = "RBD access timestamp refresh interval";

  opt->add_options()
    (RBD_ATIME_PERIOD.c_str(), po::value<uint64_t>(), description.c_str());
}
